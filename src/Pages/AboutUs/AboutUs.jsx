...
const AboutUs = () => {
    return (
        <div className="max-w-7xl mx-auto px-4 space-y-8 sm:space-y-10 md:space-y-12">
            ...
            <h3 className="text-center text-2xl sm:text-3xl md:text-4xl font-bold mt-4 sm:mt-6" data-aos="fade-down">
                About Us
            </h3>
            ...
            <div className="space-y-4 sm:space-y-5 text-center md:text-left px-2 sm:px-4">
                ...
                <div className="md:ml-8 lg:ml-20" data-aos="fade-left">
            ...
            <div className="rounded-xl" data-aos="zoom-in">
                <MissionSection2 />
            </div>
